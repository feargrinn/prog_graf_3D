...
// helper function for rotation matrix (CameraMovement)
namespace {
    glm::mat3 rotation(float angle, const glm::vec3 &axis) {
        ...
        // matrix describing rotation by angle around axis (through origin)
        return glm::mat3(
            c + u.x * u.x * (1.0f - c),
...
public:
    ...
    // getters for CameraMovement values
    ...
    // move origin to c, rotate, move back
