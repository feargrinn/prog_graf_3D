...
void SimpleShapeApplication::init() {
    ...
    auto square = xe::load_mesh_from_obj(std::string(ROOT_DIR) + "/Models/square_specular.obj", std::string(ROOT_DIR) + "/Models");
    add_mesh(square);
    // auto square = xe::load_mesh_from_obj(std::string(ROOT_DIR) + "/Models/blue_marble.obj", std::string(ROOT_DIR) + "/Models");
    // add_mesh(square);
